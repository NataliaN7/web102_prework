...
unfundedGamesInfo.textContent = unfundedGamesText;
...
const mostFundedName = mostFunded.name;
const secondMostFundedName = secondMostFunded.name;

// create a new element to hold the name of the top pledge game, then append it to the correct element
const mostFundedElement = document.createElement("div");
mostFundedElement.textContent = mostFundedName;
const firstGameContainer = document.getElementById("first-game");
firstGameContainer.appendChild(mostFundedElement);

// do the same for the runner up item
const secondMostFundedElement = document.createElement("div");
secondMostFundedElement.textContent = secondMostFundedName;
